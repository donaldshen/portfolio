...
(function () {
    function buildProjectHTML(project) {
        ...
        projectHTML = projectHTML.replace(/%img%/g, project.img);
        projectHTML = projectHTML.replace('%alt%', project.alt);
        projectHTML = projectHTML.replace('%url%', project.url);
        projectHTML = projectHTML.replace('%description%', project.description);
        return projectHTML;
    }
